...
VL_ATTR_COLD void VTestbench___024root___dump_triggers__act(VTestbench___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge Testbench.clk or negedge Testbench.rstn)\n");
    }
...
VL_ATTR_COLD void VTestbench___024root___dump_triggers__nba(VTestbench___024root* vlSelf) {
    ...
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge Testbench.clk or negedge Testbench.rstn)\n");
    }
...
VL_ATTR_COLD void VTestbench___024root___ctor_var_reset(VTestbench___024root* vlSelf) {
    ...
    vlSelf->Testbench__DOT__fsm__DOT__current_state = VL_RAND_RESET_I(2);
    vlSelf->__Vdly__Testbench__DOT__fsm__DOT__current_state = VL_RAND_RESET_I(2);
